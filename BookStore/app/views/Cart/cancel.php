...
<body>
    <nav class="navbar navbar-light navbar-expand-md text-center">
        <div class="container-fluid"><a class="navbar-brand" href="../Home/index.html" style="font-size: 30px;">AllBookedUp!</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span
    ...
    <div class="container" style="min-height: 100vh;">
        <h1 style="margin-bottom: 25px;margin-top: 40px;">Payment Unsuccessful</h1>
