...
<body>
    <nav class="navbar navbar-light navbar-expand-md text-center">
        <div class="container-fluid"><a class="navbar-brand" href="../Home/index.html"
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown show"><a class="dropdown-toggle nav-link" aria-expanded="true"
                        ...
                        <div class="dropdown-menu show"><a class="dropdown-item" href="classic.html">Classic</a><a
                                class="dropdown-item" href="fiction.html">Fiction</a><a class="dropdown-item"
                                href="#">Non-fiction</a><a class="dropdown-item" href="romance.html">Romance</a><a
                                class="dropdown-item" href="self_helf.html">Self-help &amp; wellness</a></div>
                    </li>
                ...
                <form class="d-flex me-auto navbar-form" target="_self">
                    ...
                    class="navbar-text"> <a class="login" href="../Login/login.html" style="margin: 20px;">Log
                        In</a></span>
                <span class="navbar-text"> <a class="login" href="../Login/signup.html" style="margin: 10px;">Sign
                        up</a></span>
            </div>
        </div>
    </nav>
    <div class="container">
        <h1 style="margin-bottom: 25px;margin-top: 30px;">Fiction</h1>
