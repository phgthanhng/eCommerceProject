...
<body>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown show"><a class="dropdown-toggle nav-link" aria-expanded="true" data-bs-toggle="dropdown" href="#">Categories</a>
                        <div class="dropdown-menu show"><a class="dropdown-item" href="classic.php">Classic</a><a class="dropdown-item" href="fiction.html">Fiction</a><a class="dropdown-item" href="#">Non-fiction</a><a class="dropdown-item" href="romance.html">Romance</a><a class="dropdown-item"
                                href="self_helf.html">Self-help &amp; wellness</a></div>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo URLROOT; ?>/Home/popularBooks">Popular books</a></li>
    ...
    <div class="container">
        <h1 style="margin-bottom: 25px;margin-top: 30px;">Classic</h1>
