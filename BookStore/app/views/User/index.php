...
<div class="text-end" style="margin: 10px;margin-top: 30px;"><a href="<?php echo URLROOT; ?>/User/editCredentials/<?php echo $_SESSION['user_id']; ?>" style="color: #000000;margin-right: 20px;">Change your password</a></div>
<div class="text-end" style="margin: 10px;margin-top: 10px;"><a href="<?php echo URLROOT; ?>/User/editProfile/<?php echo $_SESSION['user_id']; ?>" style="color: #000000;margin-right: 20px;">Edit profile</a></div>
<div class="container">
      ...
      <tbody>
        ...
        if (!empty($data["reviews"])) {
          foreach ($data["reviews"] as $review) {
            ...
            echo "<td>
                    <a href='/eCommerceProject/BookStore/Order/editReview/$review->reviewID'> Edit</a>
                </td>";

            echo "<td>
                    <a href='/eCommerceProject/BookStore/Order/deleteReview/$review->reviewID'> Delete</a>
                </td>";
