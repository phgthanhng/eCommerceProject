...
<form class="px-4 py-3" method="post" action="">
    <div class="container">
        <div class="d-flex flex-column justify-content-center" id="login-box">
            ...
            <input type="email" name="email" id="email" class="email-imput form-control" style="margin-top:10px;" required="" placeholder="Email" minlength="6">
            ...
            <input type="tel" name="phone" id="phone" class="form-control" style="margin-top:10px;" pattern="^\d{3}-\d{3}-\d{4}$" required="" placeholder="xxx-xxx-xxxx" minlength="10">
            </div>   
            ...
            <button class="btn btn-primary d-block box-shadow w-100" id="submit-id-submit" name="signup" type="submit">sign
                ...
                <div class="d-flex justify-content-between">
                    <div class="form-check form-check-inline" id="form-check-rememberMe"><input class="form-check-input" type="checkbox" id="formCheck-1" for="remember" style="cursor:pointer;" name="check"><label class="form-check-label" for="formCheck-1"><span class="label-text">Remember
                                Me</span></label></div>
                </div>
            </div>
