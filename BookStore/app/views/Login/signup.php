            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown show"><a class="dropdown-toggle nav-link" aria-expanded="true" data-bs-toggle="dropdown" href="#">Categories</a>
                        <div class="dropdown-menu show"><a class="dropdown-item" href="../Categories/classic.html">Classic</a><a class="dropdown-item" href="../Categories/fiction.html">Fiction</a><a class="dropdown-item" href="../Categories/non_fiction.html">Non-fiction</a><a class="dropdown-item"
                ...
                </form><span class="navbar-text"> <a class="login" href="../Home/index.html" style="margin: 20px;">Log In</a></span><span class="navbar-text"> <a class="login" href="signup.html" style="margin: 10px;">Sign up</a></span></div>
        </div>
    </nav>
    <div class="container">
        <div class="d-flex flex-column justify-content-center" id="login-box">
            ...
            <div class="email-login" style="background-color:#ffffff;"><input type="email" class="email-imput form-control" style="margin-top:10px;" required="" placeholder="Email" minlength="6"><input type="password" class="password-input form-control" style="margin-top:10px;" required="" placeholder="Password"
                    minlength="6"></div>
            <div class="submit-row" style="margin-bottom:8px;padding-top:0px;"><button class="btn btn-primary d-block box-shadow w-100" id="submit-id-submit" type="submit">sign up</button>
            ...
            <div id="login-box-footer" style="padding:10px 20px;padding-bottom:23px;padding-top:18px;">
                <p style="margin-bottom:0px;">Already have an account?<a id="register-link" href="login.html">Log In!</a></p>
            </div>
        </div>
    </div>
