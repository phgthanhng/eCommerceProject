            ...
            <div class="row row-sm">
                <div class="col-md-6 _boxzoom">
                    <div class="_product-images">
                        <div class="picZoomer">
                        <?php echo '<img class ="my_img" src="' . URLROOT . '/public/img/' . $book->image . '" style="width:200px; height 80px;"'; ?>
                        <?php echo URLROOT; ?>/Login/index    
                        <img class="my_img" src="<?php echo URLROOT; ?>/public/img/<?php $book->image?>" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
