...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2022 at 12:58 AM
...
(53, 'Kafka On The Shore', '9781400079278', 'Haruki Murakami', 'Knopf Doubleday Publishing Group', '21.27', 20, '6282b9ce6d501.png', 'Kafka on the Shore displays one of the world’s great storytellers at the peak of his powers.\r\n\r\nHere we meet a teenage boy, Kafka Tamura, who is on the run, and Nakata, an aging simpleton who is drawn to Kafka for reasons that he cannot fathom. As their paths converge, acclaimed author Haruki Murakami enfolds readers in a world where cats talk, fish fall from the sky, and spirits slip out of their bodies to make love or commit murder, in what is a truly remarkable journey.', 'Fiction');
...
(24, 5, 1, 'Cj', 'Castro', 'chi@yahoo.ca', '2022-05-16 19:10:25', 'completed', '4438 René-Lévesque Blvd  Montreal, Quebec, H3B 4W8', '268.21', 'on', 'Cj Castro', '4351 2313 1313 1', 312, 1123),
(25, 5, 2, 'Cj', 'Castro', 'chi@yahoo.ca', '2022-05-16 20:57:12', 'completed', '4438 René-Lévesque Blvd  Montreal, Quebec, H3B 4W8', '91.94', 'credit', 'Cj Castro', '1234 1234 1234 1', 212, 1123),
(26, 5, 3, 'Test', 'User', 'testuser@yahoo.ca', '2022-05-16 20:57:37', 'shipped', '4438 René-Lévesque Blvd  Montreal, Quebec, H3B 4W8', '231.07', 'credit', 'Test User', '1234 1234 1234 1', 123, 1022),
(27, 5, 5, 'Test', 'User', 'testuser@yahoo.ca', '2022-05-16 20:16:04', 'unshipped', '4438 René-Lévesque Blvd  Montreal, Quebec, H3B 4W8', '32.19', 'credit', 'Test User', '1234 1234 1234 1', 123, 1022);
...
INSERT INTO `review` (`reviewID`, `bookID`, `userID`, `reviewdate`, `reviewcontent`, `reviewmark`) VALUES
(8, 4, 5, '2022-05-16 20:35:41', 'Very Good Story!', 5);
...
INSERT INTO `user` (`userID`, `username`, `password`, `firstname`, `lastname`, `phone`, `address`, `email`, `newsletter`, `secret`) VALUES
...
(2, 'chilcj', '$2y$10$kRtx/v9WHwzkNDPqKW0FU.emqBuVwyu5fxM2tfAk1.zyz2UnrIhvi', 'Chilka', 'Castro', '438-397-6747', '7704 ruer Verdier Saint Leonard Quebec H12S2H9', 'chilcjcastro@yahoo.ca', 'no', 'CNASJBZJTPTQIUY7'),
...
(5, 'testuser', '$2y$10$GNixtkeBlGtTdqZiiXwtvuXBeG7UIgSS8F8lcH4NFeha.DyqA897a', 'Test', 'User', '438-398-9138', '5450 Côte-des-Neiges Rd, Montreal, Quebec H3T 1Y6,', 'testuser@gmail.com', 'yes', 'DIWZWVSPYQ76WWGQ'),
...
--
ALTER TABLE `cartitem`
  MODIFY `cartitemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
...
--
ALTER TABLE `wishlistitem`
  MODIFY `wishlist_itemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
