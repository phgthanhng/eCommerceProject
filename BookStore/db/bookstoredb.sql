...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2022 at 07:07 PM
...
(13, 5, 19, 'cc xx', 'swq', 'sqw@ya.ca', '2022-04-28 04:07:41', 'unshipped', '231 wuehwjkdhw Quebech2131', '357.62', 'on', 'cc cc', '1231231232312', 123, 1122),
(14, 5, 20, 'dsad', 'sadsad', 'sd@ya.ca', '2022-04-28 04:12:35', 'unshipped', '1221 wjhedj2h32Quebechg2123', '120.69', 'on', 'cc xcs', '2131-1231-2311-1', 133, 1122);
...
(2, 'chilcj', '$2y$10$kRtx/v9WHwzkNDPqKW0FU.emqBuVwyu5fxM2tfAk1.zyz2UnrIhvi', 'Chilka', 'Castro', '438-397-6747', '7704 ruer Verdier Saint Leonard Quebec H12S2H9', 'chilcjcastro@yahoo.ca', 'no', 'BJLDAXZ2BHUSVLTC'),
...
(8, 'testuser2', '$2y$10$kNEBJjHeKnL7a2DhR7hQLuAtneYtMt4a379adSL0DRtU6XV2SFYWe', 'test', 'user2', '435-133-1231', '666 straigh to hell', 'testuser2@email.com', 'yes', NULL),
...
--
ALTER TABLE `cartitem`
  MODIFY `cartitemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
...
--
ALTER TABLE `wishlistitem`
  MODIFY `wishlist_itemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
